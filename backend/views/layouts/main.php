      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme ms-3 mt-4 rounded" style="height: 90vh; position: fixed;">
          ...
          <ul class="menu-inner py-1 ">
            <!-- Dashboard -->
            <li class="menu-item <?php if(str_contains(Url::current(), 'site')):?><?= 'active'?><?php endif;?>">
              <?= Html::a('<i class="fa-solid fa-house me-2"></i><div data-i18n="Analytics">Dashboard</div>',['/site/login'],['class' => ['menu-link']])?>
            </li>
            <li class="menu-item <?php if(str_contains(Url::current(), 'buku')):?><?= 'active'?><?php endif;?>">
              <?= Html::a('<i class="fa-solid fa-book me-2"></i><div data-i18n="Analytics">Data Buku</div>',['/buku'],['class' => ['menu-link']])?>
            </li>
            <li class="menu-item <?php if(str_contains(Url::current(), 'anggota')):?><?= 'active'?><?php endif;?>">
              <?= Html::a('<i class="fa-solid fa-user-plus me-2"></i><div data-i18n="Analytics">Data Anggota</div>',['/anggota'],['class' => ['menu-link']])?>
            </li>
            <li class="menu-item <?php if(str_contains(Url::current(), 'petugas')):?><?= 'active'?><?php endif;?>">
              <?= Html::a('<i class="fa-solid fa-user-tie me-2"></i><div data-i18n="Analytics">Data Petugas</div>',['/petugas'],['class' => ['menu-link']])?>
            </li>
            <li class="menu-item <?php if(str_contains(Url::current(), 'peminjaman')):?><?= 'active'?><?php endif;?>">
              <?= Html::a('<i class="fa-solid fa-angles-up me-2"></i><div data-i18n="Analytics">Transaksi Peminjaman</div>',['/peminjaman'],['class' => ['menu-link']])?>
            </li>
            <li class="menu-item <?php if(str_contains(Url::current(), 'pengembalian')):?><?= 'active'?><?php endif;?>">
              <?= Html::a('<i class="fa-solid fa-angles-down me-2"></i><div data-i18n="Analytics">Transaksi Pengembalian</div>',['/pengembalian'],['class' => ['menu-link']])?>
            </li>
            <li class="menu-item <?php if(str_contains(Url::current(), 'signup')):?><?= 'active'?><?php endif;?>">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-end ms-auto">
                <li class="me-2">
                    <?=
                        Html::submitButton(
                        'Helloo.. '.Yii::$app->user->identity->username,
                        ['class' => 'btn btn-light text-decoration-none', 'disabled' => true]
                    )
                    ?>
                </li>
                      ...
                      <?php
                          if (Yii::$app->user->isGuest) {
                            ...
                            echo Html::beginForm(['/site/logout'], 'post', ['class' => 'd-flex'])
                                . Html::submitButton(
                                    'Logout',
                                    ['class' => 'btn btn-danger logout text-decoration-none']
                                )
                                . Html::endForm();
                        }
                      ?>
